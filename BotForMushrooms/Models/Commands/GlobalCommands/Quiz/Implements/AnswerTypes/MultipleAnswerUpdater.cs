...
{
    public class MultipleAnswerUpdater : IQuizAnswerUpdater, ICommand<Message>, IListener<PollAnswer, GlobalCommandExecutor>
    {
        ...
        public Message? QuiestionMessage { get; set; }
        ...
        public async Task GetResult(ITelegramBotClient client)
        {
            ...
            {
                resultString += userPoints.Key + ": +" + userPoints.Value + ' ' + (userPoints.Value == 1? "🟢" : "🔴") + '\n';
            }
